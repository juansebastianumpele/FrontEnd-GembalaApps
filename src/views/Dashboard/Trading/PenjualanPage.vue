                        ...
                        <div class="row">
                            <div class="col">
                                <base-input class="m-0" name="varietas" placeholder="Varietas">
                                    <multi-select v-model="input.varietas" :options="g$ddVarietas" label="name"
                                        track-by="id" placeholder="Pilih Varietas" :show-labels="false" />
                                </base-input>
                            </div>
                            <div class="col">
                                <base-input class="m-0" name="fase" placeholder="Fase">
                                    <multi-select v-model="input.fase" :options="g$ddFasePemeliharaan" label="name"
                                        track-by="id" placeholder="Pilih Fase Pemeliharaan" :show-labels="false" />
                                </base-input>
                            </div>
                            <div class="col">
                                <base-input class="m-0" name="kandang" placeholder="Kandang">
                                    <multi-select v-model="input.kandang" :options="g$ddKandang" label="name"
                                        track-by="id" placeholder="Pilih Kandang" :show-labels="false" />
                                </base-input>
                            </div>
                            <div class="col-auto">
                                <base-button class="m-0" size="md" type="primary" @click="filterTernak">Cari
                                </base-button>
            ...
            <div class="row">
                <div class="col">
                    <card-comp bodyClasses="p-0">
                        <data-table :index="false" :limitable="false" :searchable="false" :data="g$tabelFilter"
                            :columns="dt.column" :actions="dt.action" @detail-ternak="triggerdetailTernak" />
                    </card-comp>
                </div>
            </div>
        </template>
